...
const AdminDateSelector = ({ selectedDate, onDateChange, allowPastDates = false }) => {
    ...
    const isDateBeforeToday = (date) => {
      if (allowPastDates) return false; // Allow all dates if past dates are allowed
            ...
            return (
              <Button
                ...
                sx={{
                  ...
                  // Disable and grey out past dates only if not allowed
